...
// Create batch on Hyperledger Fabric
router.post('/create-batch', authenticateToken, async (req, res) => {
  try {
    ...
    res.json({
      ...
      data: result,
      network: 'hyperledger-fabric',
      message: result.success ? 'Batch created successfully on Hyperledger Fabric' : 'Failed to create batch'
    });
  } catch (error) {
...
// Add quality test event to Hyperledger Fabric
router.post('/add-quality-test', authenticateToken, async (req, res) => {
  try {
    ...
    res.json({
      ...
      data: result,
      network: 'hyperledger-fabric',
      message: result.success ? 'Quality test event added successfully to Hyperledger Fabric' : 'Failed to add quality test event'
    });
  } catch (error) {
...
// Add processing event to Hyperledger Fabric
router.post('/add-processing', authenticateToken, async (req, res) => {
  try {
    ...
    res.json({
      ...
      data: result,
      network: 'hyperledger-fabric',
      message: result.success ? 'Processing event added successfully to Hyperledger Fabric' : 'Failed to add processing event'
    });
  } catch (error) {
...
// Add manufacturing event to Hyperledger Fabric
router.post('/add-manufacturing', authenticateToken, async (req, res) => {
  try {
    ...
    res.json({
      ...
      data: result,
      network: 'hyperledger-fabric',
      message: result.success ? 'Manufacturing event added successfully to Hyperledger Fabric' : 'Failed to add manufacturing event'
    });
  } catch (error) {
